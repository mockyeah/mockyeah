...
`mockyeah` exports an instance of the [Server](API/Server) class
with local configuration or defaults.

See [Configuration](Configuration) for more info on how to configure.

To create your server programmatically, see [Server](API/Server].
