...
See [@mockyeah/fetch Configuration responseHeaders](../Packages/mockyeah-fetch/Configuration#responseHeaders).
...
See [@mockyeah/fetch Configuration aliases](../Packages/mockyeah-fetch/Configuration#aliases).

## `modifyRequest`

See [@mockyeah/fetch Configuration modifyRequest](../Packages/mockyeah-fetch/Configuration#modifyRequest).

### `groups`

When using `--only`, rather than always typing out regular expressions, you can define them here, so that rather than:
