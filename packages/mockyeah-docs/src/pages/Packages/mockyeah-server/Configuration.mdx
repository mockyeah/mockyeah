...
See [@mocyeah/fetch Configuration responseHeaders](../Packages/mockyeah-fetch/Configuration#responseHeaders).
...
See [@mocyeah/fetch Configuration aliases](../Packages/mockyeah-fetch/Configuration#aliases).

## `modifyRequest`

See [@mocyeah/fetch Configuration modifyRequest](../Packages/mockyeah-fetch/Configuration#modifyRequest).
