...
- `name` (`string`)
  - Optional name for this mock. This will be used in logs, echoed as a `x-mockyeah-name` header with the [`responseHeaders`](../mockyeah-fetch/Configuration#responseheaders) option, etc.
