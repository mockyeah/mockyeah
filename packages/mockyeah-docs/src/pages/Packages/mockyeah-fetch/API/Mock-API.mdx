...
- `name` (`string`)
  - Optional name for this mock. This will be used in logs, echoed as a `x-mockyeah-name` header with the [`responseHeaders`](../Configuration#responseheaders) option, etc.
